...
import {Button_fb_google, FontStyles,} from '../styelsheets/MainStyle';
        ...
        return (
                        ...
                        <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: 2, }}>
                            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', }}>
                                ...
                                />
                                <View style={{ width: 50 }}>
                        <Text style={[FontStyles.font, { textAlign: 'center'}]}>Patient details</Text>
                                </View>
                            </View>
                            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', }}>
                                <Image style={Button_fb_google.image}
                                ...
                                />
                                <View style={{ width: 50 }}>
                                    <Text style={[FontStyles.font, { textAlign: 'center'}]}>Review details</Text>
                                </View>
                            </View>
                            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', }}>
                                <Image style={Button_fb_google.image}
                                ...
                                />
                                <View style={{ width: 60 }}>
                                    <Text style={[FontStyles.font, { textAlign: 'center'}]}>Payment details</Text>
                                </View>
                            </View>
                        </View>
